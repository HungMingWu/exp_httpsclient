...
class bs_set_impl
   ...
   : public bstree_impl<ValueTraits, VoidOrKeyOfValue, Compare, ConstantTimeSize, BsTreeAlgorithms, HeaderHolder>
#endif
{
   /// @cond
   typedef bstree_impl<ValueTraits, VoidOrKeyOfValue, Compare, ConstantTimeSize, BsTreeAlgorithms, HeaderHolder> tree_type;
   ...
   bs_set_impl(const bs_set_impl&) = delete;
   bs_set_impl& operator=(const bs_set_impl&) = delete;
   //! @copydoc ::boost::intrusive::bstree::bstree(bstree &&)
   bs_set_impl(bs_set_impl&& x) : tree_type(std::move(x)) {}

   //! @copydoc ::boost::intrusive::bstree::operator=(bstree &&)
   bs_set_impl& operator=(bs_set_impl&& x)
   {  return static_cast<bs_set_impl&>(tree_type::operator=(std::move(x))); }
   ...
   static bs_set_impl &container_from_end_iterator(iterator end_iterator) noexcept;

   //! @copydoc ::boost::intrusive::bstree::container_from_end_iterator(const_iterator)
   static const bs_set_impl &container_from_end_iterator(const_iterator end_iterator) noexcept;

   //! @copydoc ::boost::intrusive::bstree::container_from_iterator(iterator)
   static bs_set_impl &container_from_iterator(iterator it) noexcept;

   //! @copydoc ::boost::intrusive::bstree::container_from_iterator(const_iterator)
   static const bs_set_impl &container_from_iterator(const_iterator it) noexcept;
   ...
   template <class Cloner, class Disposer>
   void clone_from(bs_set_impl&& src, Cloner cloner, Disposer disposer)
   {  tree_type::clone_from(std::forward<bs_set_impl>(src), cloner, disposer);  }
   ...
   void merge(bs_set_impl<ValueTraits, VoidOrKeyOfValue, Compare2, ConstantTimeSize, HeaderHolder> &source)
   {  return tree_type::merge_unique(source);  }


   template<class Compare2>
   void merge(bs_multiset_impl<ValueTraits, VoidOrKeyOfValue, Compare2, ConstantTimeSize, HeaderHolder> &source)
   {  return tree_type::merge_unique(source);  }
   ...
   >::type
{
   ...
   {}
   bs_set(const bs_set&) = delete;
   bs_set& operator=(const bs_set&) = delete;
   inline bs_set(bs_set&& x) : Base(std::move(x)) {}

   inline bs_set& operator=(bs_set&& x)
   {  return static_cast<bs_set &>(this->Base::operator=(std::move(x)));  }
   ...
   template <class Cloner, class Disposer>
   inline void clone_from(bs_set&& src, Cloner cloner, Disposer disposer)
   {  Base::clone_from(std::forward<bs_set>(src), cloner, disposer);  }

   inline static bs_set &container_from_end_iterator(iterator end_iterator) noexcept
   {  return static_cast<bs_set &>(Base::container_from_end_iterator(end_iterator));   }

   inline static const bs_set &container_from_end_iterator(const_iterator end_iterator) noexcept
   {  return static_cast<const bs_set &>(Base::container_from_end_iterator(end_iterator));   }

   inline static bs_set &container_from_iterator(iterator it) noexcept
   {  return static_cast<bs_set &>(Base::container_from_iterator(it));   }

   inline static const bs_set &container_from_iterator(const_iterator it) noexcept
...
#endif
{
   ...
   bs_multiset_impl(const bs_multiset_impl&) = delete;
   bs_multiset_impl& operator=(const bs_multiset_impl&) = delete;
   //! @copydoc ::boost::intrusive::bstree::bstree(bstree &&)
   bs_multiset_impl(bs_multiset_impl&& x) = default;

   //! @copydoc ::boost::intrusive::bstree::operator=(bstree &&)
   bs_multiset_impl& operator=(bs_multiset_impl&& x)
   {  return static_cast<bs_multiset_impl&>(tree_type::operator=(std::move(x))); }
   ...
   //! @copydoc ::boost::intrusive::bstree::container_from_end_iterator(iterator)
   static bs_multiset_impl &container_from_end_iterator(iterator end_iterator) noexcept;

   //! @copydoc ::boost::intrusive::bstree::container_from_end_iterator(const_iterator)
   static const bs_multiset_impl &container_from_end_iterator(const_iterator end_iterator) noexcept;

   //! @copydoc ::boost::intrusive::bstree::container_from_iterator(iterator)
   static bs_multiset_impl &container_from_iterator(iterator it) noexcept;

   //! @copydoc ::boost::intrusive::bstree::container_from_iterator(const_iterator)
   static const bs_multiset_impl &container_from_iterator(const_iterator it) noexcept;
   ...
   //! @copydoc ::boost::intrusive::bstree::clone_from(bstree&&,Cloner,Disposer)
   template <class Cloner, class Disposer>
   void clone_from(bs_multiset_impl&& src, Cloner cloner, Disposer disposer)
   {  tree_type::clone_from(std::forward<bs_multiset_impl>(src), cloner, disposer);  }
      ...
      >::type
{
   ...
   bs_multiset(const bs_multiset&) = delete;
   bs_multiset& operator=(const bs_multiset&) = delete;
   inline bs_multiset(bs_multiset&& x) = default;

   inline bs_multiset& operator=(bs_multiset&& x)
   {  return static_cast<bs_multiset &>(this->Base::operator=(std::move(x)));  }
   ...
   template <class Cloner, class Disposer>
   inline void clone_from(bs_multiset&& src, Cloner cloner, Disposer disposer)
   {  Base::clone_from(std::forward<bs_multiset>(src), cloner, disposer);  }

   inline static bs_multiset &container_from_end_iterator(iterator end_iterator) noexcept
   {  return static_cast<bs_multiset &>(Base::container_from_end_iterator(end_iterator));   }

   inline static const bs_multiset &container_from_end_iterator(const_iterator end_iterator) noexcept
   {  return static_cast<const bs_multiset &>(Base::container_from_end_iterator(end_iterator));   }

   inline static bs_multiset &container_from_iterator(iterator it) noexcept
   {  return static_cast<bs_multiset &>(Base::container_from_iterator(it));   }

   inline static const bs_multiset &container_from_iterator(const_iterator it) noexcept
