...
struct trivial_value_traits
{
   ...
   inline static node_ptr       to_node_ptr (value_type &value) noexcept
      {  return pointer_traits<node_ptr>::pointer_to(value);  }
   inline static const_node_ptr to_node_ptr (const value_type &value) noexcept
      {  return pointer_traits<const_node_ptr>::pointer_to(value);  }
   inline static const pointer  &      to_value_ptr(const node_ptr &n) noexcept
      {  return n; }
   inline static const const_pointer  &to_value_ptr(const const_node_ptr &n) noexcept
      {  return n; }
};
