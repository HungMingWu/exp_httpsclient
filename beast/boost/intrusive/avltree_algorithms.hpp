...
struct avltree_node_cloner
{
   ...
   inline avltree_node_cloner(F f) :  functor(f) {}
   ...
   inline node_ptr operator()(const node_ptr & p) const
   {
      node_ptr n = functor(p);
      NodeTraits::set_balance(n, NodeTraits::get_balance(p));
      return n;
      ...
      : public bstree_node_checker<ValueTraits, NodePtrCompare, ExtraChecker>
{
   ...
   {
      return_type() = default;
      explicit return_type(const const_node_ptr& p,
   ...
   #endif
{
   ...
   static node_ptr get_header(const const_node_ptr & n) noexcept;

   //! @copydoc ::boost::intrusive::bstree_algorithms::begin_node
   static node_ptr begin_node(const const_node_ptr & header) noexcept;

   //! @copydoc ::boost::intrusive::bstree_algorithms::end_node
   static node_ptr end_node(const const_node_ptr & header) noexcept;
   ...
   static void unlink(node_ptr node) noexcept
   {
   ...
   static node_ptr unlink_leftmost_without_rebalance(const node_ptr & header) noexcept;

   //! @copydoc ::boost::intrusive::bstree_algorithms::unique(const const_node_ptr&)
   static bool unique(const const_node_ptr & node) noexcept;

   //! @copydoc ::boost::intrusive::bstree_algorithms::size(const const_node_ptr&)
   static std::size_t size(const const_node_ptr & header) noexcept;

   //! @copydoc ::boost::intrusive::bstree_algorithms::next_node(const node_ptr&)
   static node_ptr next_node(const node_ptr & node) noexcept;

   //! @copydoc ::boost::intrusive::bstree_algorithms::prev_node(const node_ptr&)
   static node_ptr prev_node(const node_ptr & node) noexcept;

   //! @copydoc ::boost::intrusive::bstree_algorithms::init(node_ptr)
   static void init(const node_ptr & node) noexcept;
   #endif   //#ifdef BOOST_INTRUSIVE_DOXYGEN_INVOKED
   ...
   static void clear_and_dispose(const node_ptr & header, Disposer disposer) noexcept;
   ...
   static bool is_header(const const_node_ptr & p) noexcept
   ...
   static void rebalance_after_insertion(node_ptr header, node_ptr x) noexcept
   {
   ...
   static void left_right_balancing(node_ptr a, node_ptr b, node_ptr c) noexcept
   {
      // balancing...
   ...
   static node_ptr avl_rotate_left_right(const node_ptr a, const node_ptr a_oldleft, node_ptr hdr) noexcept
   {  // [note: 'a_oldleft' is 'b']
      //             |                               |         //
      //             a(-2)                           c         //
      //            / \                             / \        //
   ...
   static node_ptr avl_rotate_right_left(const node_ptr a, const node_ptr a_oldright, node_ptr hdr) noexcept
   ...
   static void avl_rotate_left(node_ptr x, node_ptr x_oldright, node_ptr hdr) noexcept
   {
   ...
   static void avl_rotate_right(node_ptr x, node_ptr x_oldleft, node_ptr hdr) noexcept
   {
