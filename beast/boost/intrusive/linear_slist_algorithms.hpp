   ...
   /// @endcond
{
   ...
   //!
   //! <b>Throws</b>: Nothing.
   static void init(const node_ptr & this_node) noexcept;
   ...
   //!
   //! <b>Throws</b>: Nothing.
   static void unlink_after(const node_ptr & prev_node) noexcept;
   ...
   //!
   //! <b>Throws</b>: Nothing.
   static void unlink_after(const node_ptr & prev_node, const node_ptr & last_node) noexcept;
   ...
   //!
   //! <b>Throws</b>: Nothing.
   static void link_after(const node_ptr & prev_node, const node_ptr & this_node) noexcept;
   ...
   //!
   //! <b>Throws</b>: Nothing.
   static void transfer_after(const node_ptr & p, const node_ptr & b, const node_ptr & e) noexcept;
   ...
   //!
   //! <b>Throws</b>: Nothing.
   inline static void init_header(const node_ptr & this_node) noexcept
   ...
   inline static node_ptr
      get_previous_node(const node_ptr & prev_init_node, const node_ptr & this_node) noexcept
   ...
   //!
   //! <b>Throws</b>: Nothing.
   inline static void swap_trailing_nodes(node_ptr this_node, node_ptr other_node) noexcept
   {
   ...
   static node_pair move_first_n_backwards(node_ptr p, std::size_t n) noexcept
   {
      ...
      return std::make_pair(first, new_last);
   }
