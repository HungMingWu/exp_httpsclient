   ...
   /// @endcond
{
   ...
   //!
   //! <b>Throws</b>: Nothing.
   inline static node_ptr get_previous_node(const node_ptr &prev_init_node, const node_ptr &this_node) noexcept
   ...
   //!
   //! <b>Throws</b>: Nothing.
   inline static node_ptr get_previous_node(const node_ptr & this_node) noexcept
   ...
   //!
   //! <b>Throws</b>: Nothing.
   inline static node_ptr get_previous_previous_node(const node_ptr & this_node) noexcept
   ...
   //!
   //! <b>Throws</b>: Nothing.
   static node_ptr get_previous_previous_node(node_ptr p, const node_ptr & this_node) noexcept
   {
   ...
   //!
   //! <b>Throws</b>: Nothing.
   inline static void unlink(node_ptr this_node) noexcept
   {
   ...
   //!
   //! <b>Throws</b>: Nothing.
   inline static void link_before (node_ptr nxt_node, node_ptr this_node) noexcept
