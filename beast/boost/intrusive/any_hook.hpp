...
template <typename T>
concept internal_base_hook1 = std::is_convertible_v<decltype(T::hooktags::is_base_hook), bool> && T::hooktags::is_base_hook;
...
struct any_to_some_hook
{
   ...
   struct pack : public Base
   {
      struct proto_value_traits
      {
         ...
         struct hooktags
         {
            static const bool is_base_hook = internal_base_hook1<old_proto_value_traits>;
         };
