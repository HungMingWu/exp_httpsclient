...
class splaytree_impl
   /// @cond
   :  public bstree_impl<ValueTraits, VoidOrKeyOfValue, VoidOrKeyComp, ConstantTimeSize, SplayTreeAlgorithms, HeaderHolder>
   /// @endcond
{
   public:
   ...
   splaytree_impl(const splaytree_impl&) = delete;
   splaytree_impl& operator=(const splaytree_impl&) = delete;
   //! @copydoc ::boost::intrusive::bstree::bstree(bstree &&)
   splaytree_impl(splaytree_impl&& x) : tree_type(std::move(x)) {}

   //! @copydoc ::boost::intrusive::bstree::operator=(bstree &&)
   splaytree_impl& operator=(splaytree_impl &&x)
   {  return static_cast<splaytree_impl&>(tree_type::operator=(std::move(x))); }
   ...
   static splaytree_impl &container_from_end_iterator(iterator end_iterator) noexcept;

   //! @copydoc ::boost::intrusive::bstree::container_from_end_iterator(const_iterator)
   static const splaytree_impl &container_from_end_iterator(const_iterator end_iterator) noexcept;

   //! @copydoc ::boost::intrusive::bstree::container_from_iterator(iterator)
   static splaytree_impl &container_from_iterator(iterator it) noexcept;

   //! @copydoc ::boost::intrusive::bstree::container_from_iterator(const_iterator)
   static const splaytree_impl &container_from_iterator(const_iterator it) noexcept;
   ...
   template <class Cloner, class Disposer>
   void clone_from(splaytree_impl&& src, Cloner cloner, Disposer disposer)
   {  tree_type::clone_from(std::forward<splaytree_impl>(src), cloner, disposer);  }
      ...
      >::type
{
   ...
   inline splaytree(splaytree&& x) : Base(std::move(x)) {}

   inline splaytree& operator=(splaytree&& x)
   {  return static_cast<splaytree &>(this->Base::operator=(std::move(x)));  }
   ...
   template <class Cloner, class Disposer>
   inline void clone_from(splaytree&& src, Cloner cloner, Disposer disposer)
   {  Base::clone_from(std::forward<splaytree>(src), cloner, disposer);  }

   inline static splaytree &container_from_end_iterator(iterator end_iterator) noexcept
   {  return static_cast<splaytree &>(Base::container_from_end_iterator(end_iterator));   }

   inline static const splaytree &container_from_end_iterator(const_iterator end_iterator) noexcept
   {  return static_cast<const splaytree &>(Base::container_from_end_iterator(end_iterator));   }

   inline static splaytree &container_from_iterator(iterator it) noexcept
   {  return static_cast<splaytree &>(Base::container_from_iterator(it));   }

   inline static const splaytree &container_from_iterator(const_iterator it) noexcept
