      ...
      : public ExtraChecker
{
                     ...
                     const return_type& check_return_left, const return_type& check_return_right)
   {
      ...
      return result_type(p, check_return_left, check_return_right);
   }
   ...
   #endif
{
      ...
      , insert_commit_data &commit_data)
   {
      ...
      if(ret.second)
         commit_data.rotations = rebalance_after_insertion_check(header, commit_data.node, prio, pcomp);
      return ret;
   }
      ...
      (node_ptr header1, NodePtrCompare comp, PrioNodePtrPrioCompare pcomp, node_ptr header2, node_ptr z)
   {
      ...
      commit_data.rotations = rebalance_after_insertion_check(header1, commit_data.node, z, pcomp);
   ...
   {
      commit_data.rotations = rebalance_after_insertion_check(h, commit_data.node, new_node, pcomp);
      //No-throw
   ...
   static std::size_t rebalance_after_insertion_check
      (const_node_ptr header, const_node_ptr up, const Key &k
      , KeyNodePriorityCompare pcomp)
   {
