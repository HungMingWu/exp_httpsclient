...
inline std::ostream& operator<<(std::ostream& s, const BPtr_Value& t)
...
{
   using val_t = BPtr_Value;
   using node = val_t;
   using node_ptr = bounded_pointer<val_t>;
   using const_node_ptr = bounded_pointer<const val_t>;
...
{
   using color = signed char;
   using node_ptr = Tree_BPtr_Node_Traits::node_ptr;
   using const_node_ptr = Tree_BPtr_Node_Traits::const_node_ptr;
...
struct AVLTree_BPtr_Node_Traits
   : public Tree_BPtr_Node_Traits
{
   using balance = signed char;
   using node_ptr = typename Tree_BPtr_Node_Traits::node_ptr;
   using const_node_ptr = typename Tree_BPtr_Node_Traits::const_node_ptr;
...
struct BPtr_Value_Traits
{
   ...
   using value_type = typename node_traits::val_t;
   using node_ptr = typename node_traits::node_ptr;
   using const_node_ptr = typename node_traits::const_node_ptr;
   using pointer = node_ptr;
   using const_pointer = const_node_ptr;
   using reference = bounded_reference<value_type>;
   using const_reference = bounded_reference<const value_type>;
   using value_traits_ptr = BPtr_Value_Traits<NodeTraits>*;

   static const boost::intrusive::link_mode_type link_mode = boost::intrusive::link_mode_type::safe_link;
...
{
   using type = bounded_reference_cont<BPtr_Value>;
};
