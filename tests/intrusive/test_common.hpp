...
struct key_type_tester
{
   ...
   static_assert(std::is_same< KeyOfValueOption
                                                          , key_of_value<int_holder_key_of_value<typename Map::value_type> >
                                                          >::value );
   static_assert( std::is_same< key_of_value_t
                                                          , int_holder_key_of_value<typename Map::value_type>
                                                          >::value );
   static_assert( std::is_same< typename Map::key_type
                                                          , typename key_of_value_t::type >::value );
   static_assert( std::is_same< typename Map::key_of_value
