...
TEST_CASE("splay_set_test void pointer 1", "splay_set_test") {
    test_main_template<void*, false, false, false, Base>::execute();
}

TEST_CASE("splay_set_test void pointer 2", "splay_set_test") {
    test_main_template<void*, false, true, false, Member>::execute();
}

TEST_CASE("splay_set_test void pointer 3", "splay_set_test") {
    test_main_template<void*, true, false, false, Base>::execute();
}

TEST_CASE("splay_set_test void pointer 4", "splay_set_test") {
    test_main_template<void*, true, true, false, Member>::execute();
}

TEST_CASE("splay_set_test void pointer 5", "splay_set_test") {
    test_main_template<void*, true, true, true, NonMember>::execute();
}

TEST_CASE("splay_set_test smart_ptr 1", "splay_set_test") {
    test_main_template<smart_ptr<void>, false, false, true, Base>::execute();
}

TEST_CASE("splay_set_test smart_ptr 2", "splay_set_test") {
    test_main_template<smart_ptr<void>, false, true, true, Member>::execute();
}

TEST_CASE("splay_set_test smart_ptr 3", "splay_set_test") {
    test_main_template<smart_ptr<void>, true, false, true, NonMember>::execute();
}

TEST_CASE("splay_set_test bounded_ptr 1", "splay_set_test") {
    test_main_template_bptr< false, false >::execute();
}

TEST_CASE("splay_set_test bounded_ptr 2", "splay_set_test") {
