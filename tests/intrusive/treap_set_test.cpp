...
public:
    static void execute()
    {
        using testval_traits_t = testvalue_traits<bs_hooks<VoidPointer>>;
        //base
        using base_hook_t = std::conditional_t
            < ConstantTimeSize
...
TEST_CASE("treap_set_test void pointer 1", "treap_set_test") {
    test_main_template<void*, false, false, false, Base>::execute();
}

TEST_CASE("treap_set_test void pointer 2", "treap_set_test") {
    test_main_template<void*, false, true, false, Member>::execute();
}

TEST_CASE("treap_set_test void pointer 3", "treap_set_test") {
    test_main_template<void*, true, false, false, Base>::execute();
}

TEST_CASE("treap_set_test void pointer 4", "treap_set_test") {
    test_main_template<void*, true, true, false, Member>::execute();
}

TEST_CASE("treap_set_test void pointer 5", "treap_set_test") {
    test_main_template<void*, true, true, true, NonMember>::execute();
}

TEST_CASE("treap_set_test smart_ptr 1", "treap_set_test") {
    test_main_template<smart_ptr<void>, false, false, true, Base>::execute();
}

TEST_CASE("treap_set_test smart_ptr 2", "treap_set_test") {
    test_main_template<smart_ptr<void>, false, true, true, Member>::execute();
}

TEST_CASE("treap_set_test smart_ptr 3", "treap_set_test") {
    test_main_template<smart_ptr<void>, true, false, true, NonMember>::execute();
}

TEST_CASE("treap_set_test bounded_ptr 1", "treap_set_test") {
    test_main_template_bptr< false, false >::execute();
}

TEST_CASE("treap_set_test bounded_ptr 2", "treap_set_test") {
