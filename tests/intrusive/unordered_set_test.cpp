...
TEST_CASE("unordered_set_test void pointer 1", "unordered_set_test") {
    test_main_template<void*, false, false, false, Base>::execute();
}

TEST_CASE("unordered_set_test void pointer 2", "unordered_set_test") {
    test_main_template<void*, false, true, false, Member>::execute();
}

TEST_CASE("unordered_set_test void pointer 3", "unordered_set_test") {
    test_main_template<void*, true, false, false, NonMember>::execute();
}

TEST_CASE("unordered_set_test void pointer 4", "unordered_set_test") {
    test_main_template<void*, true, true, false, Base>::execute();
}

TEST_CASE("unordered_set_test smart_ptr 1", "unordered_set_test") {
    test_main_template<smart_ptr<void>, false, false, false, Member>::execute();
}

TEST_CASE("unordered_set_test smart_ptr 2", "unordered_set_test") {
    test_main_template<smart_ptr<void>, false, true, false, NonMember>::execute();
}

TEST_CASE("unordered_set_test smart_ptr 3", "unordered_set_test") {
    test_main_template<smart_ptr<void>, true, false, false, Base>::execute();
}

TEST_CASE("unordered_set_test smart_ptr 4", "unordered_set_test") {
