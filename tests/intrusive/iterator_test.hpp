...
void test_iterator_compatible(C &c)
{
   ...
   static_assert((!std::is_convertible<const_reverse_iterator, reverse_iterator>::value));
...
void test_iterator_input_and_compatible(C &c)
{
   ...
   using std::is_same;
   //Trivial typedefs
   static_assert((!is_same<iterator, const_iterator>::value));
   static_assert((!is_same<reverse_iterator, const_reverse_iterator>::value));
   //difference_type
   typedef typename C::difference_type difference_type;
   static_assert((is_same<difference_type, typename nit_traits::difference_type>::value));
   static_assert((is_same<difference_type, typename cit_traits::difference_type>::value));
   static_assert((is_same<difference_type, typename rnit_traits::difference_type>::value));
   static_assert((is_same<difference_type, typename crit_traits::difference_type>::value));
   //value_type
   typedef typename C::value_type value_type;
   static_assert((is_same<value_type, typename nit_traits::value_type>::value));
   static_assert((is_same<value_type, typename cit_traits::value_type>::value));
   static_assert((is_same<value_type, typename rnit_traits::value_type>::value));
   static_assert((is_same<value_type, typename crit_traits::value_type>::value));
   //pointer
   typedef typename C::pointer pointer;
   typedef typename C::const_pointer const_pointer;
   static_assert((is_same<pointer,        typename nit_traits::pointer>::value));
   static_assert((is_same<const_pointer,  typename cit_traits::pointer>::value));
   static_assert((is_same<pointer,        typename rnit_traits::pointer>::value));
   static_assert((is_same<const_pointer,  typename crit_traits::pointer>::value));
   //reference
   typedef typename C::reference reference;
   typedef typename C::const_reference const_reference;
   static_assert((is_same<reference,         typename nit_traits::reference>::value));
   static_assert((is_same<const_reference,   typename cit_traits::reference>::value));
   static_assert((is_same<reference,         typename rnit_traits::reference>::value));
   static_assert((is_same<const_reference,   typename crit_traits::reference>::value));
   //Dynamic tests
...
void test_iterator_forward(C &c)
{
   ...
   using std::is_same;
   //iterator_category
   static_assert((is_same<std::forward_iterator_tag, typename nit_traits::iterator_category>::value));
   static_assert((is_same<std::forward_iterator_tag, typename cit_traits::iterator_category>::value));
   static_assert((is_same<std::forward_iterator_tag, typename rnit_traits::iterator_category>::value));
   static_assert((is_same<std::forward_iterator_tag, typename crit_traits::iterator_category>::value));
   //Test dynamic
   test_iterator_forward_and_compatible(c);
}
...
void test_iterator_bidirectional(C &c)
{
   ...
   using std::is_same;
   //iterator_category
   static_assert((is_same<std::bidirectional_iterator_tag, typename nit_traits::iterator_category>::value));
   static_assert((is_same<std::bidirectional_iterator_tag, typename cit_traits::iterator_category>::value));
   static_assert((is_same<std::bidirectional_iterator_tag, typename rnit_traits::iterator_category>::value));
   static_assert((is_same<std::bidirectional_iterator_tag, typename crit_traits::iterator_category>::value));
   //Test dynamic
   test_iterator_bidirectional_and_compatible(c);
}
...
void test_iterator_random(C &c)
{
   ...
   using std::is_same;
   //iterator_category
   static_assert((is_same<std::random_access_iterator_tag, typename nit_traits::iterator_category>::value));
   static_assert((is_same<std::random_access_iterator_tag, typename cit_traits::iterator_category>::value));
   static_assert((is_same<std::random_access_iterator_tag, typename rnit_traits::iterator_category>::value));
   static_assert((is_same<std::random_access_iterator_tag, typename crit_traits::iterator_category>::value));
   //Test dynamic
