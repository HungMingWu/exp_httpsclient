...
TEST_CASE("sg_set_test void pointer 1", "sg_set_test") {
    test_main_template<void*, false, false, Base>::execute();
}

TEST_CASE("sg_set_test void pointer 2", "sg_set_test") {
    test_main_template<void*, true, false, Member>::execute();
}

TEST_CASE("sg_set_test void pointer 3", "sg_set_test") {
    test_main_template<void*, false, false, Base>::execute();
}

TEST_CASE("sg_set_test void pointer 4", "sg_set_test") {
    test_main_template<void*, true, false, Member>::execute();
}

TEST_CASE("sg_set_test void pointer 5", "sg_set_test") {
    test_main_template<void*, true, true, NonMember>::execute();
}

TEST_CASE("sg_set_test smart_ptr 1", "sg_set_test") {
    test_main_template<smart_ptr<void>, false, true, Base>::execute();
}

TEST_CASE("sg_set_test smart_ptr 2", "sg_set_test") {
    test_main_template<smart_ptr<void>, true, true, Member>::execute();
}

TEST_CASE("sg_set_test smart_ptr 3", "sg_set_test") {
    test_main_template<smart_ptr<void>, false, true, NonMember>::execute();
}

TEST_CASE("sg_set_test bounded_ptr 1", "sg_set_test") {
    test_main_template_bptr<false>::execute();
}

TEST_CASE("sg_set_test bounded_ptr 2", "sg_set_test") {
    test_main_template_bptr<true>::execute();
}