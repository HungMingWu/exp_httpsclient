...
TEST_CASE("unordered_multiset_test void pointer 1", "unordered_multiset_test") {
    test_main_template<void*, false, false, false, Base>::execute();
}

TEST_CASE("unordered_multiset_test void pointer 2", "unordered_multiset_test") {
    test_main_template<void*, false, true, false, Member>::execute();
}

TEST_CASE("unordered_multiset_test void pointer 3", "unordered_multiset_test") {
    test_main_template<void*, true, false, false, NonMember>::execute();
}

TEST_CASE("unordered_multiset_test void pointer 4", "unordered_multiset_test") {
    test_main_template<void*, true, true, false, Base>::execute();
}

TEST_CASE("unordered_multiset_test smart_ptr 1", "unordered_multiset_test") {
    test_main_template<smart_ptr<void>, false, false, false, Member>::execute();
}

TEST_CASE("unordered_multiset_test smart_ptr 2", "unordered_multiset_test") {
    test_main_template<smart_ptr<void>, false, true, false, NonMember>::execute();
}

TEST_CASE("unordered_multiset_test smart_ptr 3", "unordered_multiset_test") {
    test_main_template<smart_ptr<void>, true, false, false, Base>::execute();
}

TEST_CASE("unordered_multiset_test smart_ptr 4", "unordered_multiset_test") {
